...
set(h1, 'Position', [-0.2 0.15 0.9 0.625]);
set(c1, 'Position', [0.05 0.15 0.45 0.015]);

set(h2, 'Position', [0.59 0.55 0.4 0.25]);

set(h3, 'Position', [0.59 0.15 0.4 0.25]);
...
filename='./Figures/FigureS_drought_impacts_TWS_All_zsocre_upd.png'; 
