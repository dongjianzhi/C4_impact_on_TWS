...
for J = 1:4
    ...
    if J ==1
        title('(a) E(TWS | Z_p<0)', 'FontWeight', 'bold', 'FontName', 'Arial', 'FontSize', 14);
    end

    if J ==2
        title('(b) E(TWS | Z_p<0, VPD>1.5)', 'FontWeight', 'bold', 'FontName', 'Arial', 'FontSize', 14);
    end

    if J ==3
        title('(c) E(TWS | Z_p<-1, VPD>0)', 'FontWeight', 'bold', 'FontName', 'Arial', 'FontSize', 14);
    end

    if J ==4
        title('(c) E(TWS | Z_p<-1, VPD>1.5)', 'FontWeight', 'bold', 'FontName', 'Arial', 'FontSize', 14);
    end
